...
struct yahooPuller{
    ...
    func getStockName(yahoosymbol: String) -> String{
        ...
        stockName =  yahoosymbol
        
        var nameURL = completeYahooURL(yahoosymbol)
        
        print("URL to get the name for: \(yahoosymbol): \(nameURL)")
    ...
    {print(#function, #line)
        ...
        let symbolLetter = "n"
        let finishedYahooURL =  "http://download.finance.yahoo.com/d/quotes.csv?s=\(symbol)&f=\(symbolLetter)"

        
        return finishedYahooURL
    }
